...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2023 a las 23:20:38
...
CREATE TABLE `prueba2` (
  ...
  `receta` varchar(70) NOT NULL,
  `telefono` int(20) NOT NULL,
  `otros` varchar(70) NOT NULL
...
--
ALTER TABLE `prueba2`
  MODIFY `id_paciente` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
COMMIT;
